...
public class MMF_BeautifyAnamorphicFlaresIntensity : MMF_Feedback
{
	...
	public override float FeedbackDuration
	{
		get
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v0 @ r8_v1 (Il2CppClass<MoreMountains.FeedbacksForThirdParty.MMF_BeautifyAnamorphicFlaresIntensity>)+648]");
			object obj = 0;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v0 @ r8_v1 (Il2CppClass<MoreMountains.FeedbacksForThirdParty.MMF_BeautifyAnamorphicFlaresIntensity>)+650]");
			object obj2 = 0;
	...
	protected unsafe override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1f)
	{
		...
		if (Active && FeedbackTypeAuthorized)
		{
			...
			MMBeautifyShakeEvent.Trigger(_flatCurve, 0f, 0f, _flatCurve, remapBloomThresholdZero, remapBloomThresholdOne, chromaticCurve, remapChromaticZero, 0f, null, (float)_flatCurve, 0f, null, (float)_flatCurve, 0f, 0f, (byte)(int)ShakeIntensity != 0, RemapIntensityZero, (MMChannelData)RemapIntensityOne, (byte)(int)position.x != 0, RelativeValues, (byte)(int)position.x != 0, (TimescaleModes)channelData, ResetShakerValuesAfterShake, ResetTargetValuesAfterShake);
		}
	}
	...
	protected override void CustomStopFeedback(Vector3 position, float feedbacksIntensity = 1f)
	{
		...
		if (Active && FeedbackTypeAuthorized)
		{
			...
			AnimationCurve chromaticCurve = default(AnimationCurve);
			float remapChromaticZero = default(float);
			MMBeautifyShakeEvent.Trigger(_flatCurve, 0f, 0f, _flatCurve, remapBloomThresholdZero, remapBloomThresholdOne, chromaticCurve, remapChromaticZero, 0f, null, (float)_flatCurve, 0f, null, (float)_flatCurve, 0f, 0f, (byte)(int)ShakeIntensity != 0, RemapIntensityZero, (MMChannelData)RemapIntensityOne, (byte)(int)position.x != 0, RelativeValues, forwardDirection: true, timescaleMode, stop: true, restore: true);
		}
	}
	...
	protected override void CustomRestoreInitialValues()
	{
		...
		if (Active && FeedbackTypeAuthorized)
		{
			...
			MMBeautifyShakeEvent.Trigger(_flatCurve, 0f, 0f, _flatCurve, remapBloomThresholdZero, remapBloomThresholdOne, chromaticCurve, remapChromaticZero, 0f, null, (float)_flatCurve, 0f, null, (float)_flatCurve, 0f, 0f, (byte)(int)ShakeIntensity != 0, RemapIntensityZero, (MMChannelData)RemapIntensityOne, resetShakerValuesAfterShake, RelativeValues, forwardDirection: true, timescaleMode, stop: true, restore: true);
		}
	}

	public MMF_BeautifyAnamorphicFlaresIntensity()
	{
	...
	static MMF_BeautifyAnamorphicFlaresIntensity()
	{
