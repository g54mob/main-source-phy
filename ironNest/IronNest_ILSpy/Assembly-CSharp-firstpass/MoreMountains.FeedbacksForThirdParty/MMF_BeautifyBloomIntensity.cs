...
public class MMF_BeautifyBloomIntensity : MMF_Feedback
{
	...
	public override float FeedbackDuration
	{
		get
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v0 @ r8_v1 (Il2CppClass<MoreMountains.FeedbacksForThirdParty.MMF_BeautifyBloomIntensity>)+648]");
			object obj = 0;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v0 @ r8_v1 (Il2CppClass<MoreMountains.FeedbacksForThirdParty.MMF_BeautifyBloomIntensity>)+650]");
			object obj2 = 0;
	...
	public MMF_BeautifyBloomIntensity()
	{
		...
		RemapIntensityOne = 2f;
		base._002Ector();
	}

	static MMF_BeautifyBloomIntensity()
	{
