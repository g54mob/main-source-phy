...
public class SettingInt : SettingWithValue<int>, ISettingWithConnection<int>, ISettingWithValue<int>, ISetting, ISerializationCallbackReceiver, IQualityChangeReceiver, ISettingWithConnectionSO
{
	...
	private Action<SettingInt> m_OnSettingIntChanged;
	...
	public event Action<SettingInt> OnSettingIntChanged
	{
		add
		{
			...
			object obj = this + 112;
			Delegate obj2 = this.m_OnSettingIntChanged;
	...
	public override void SetConnectionSO(ConnectionSO connectionSO)
	{
		...
		nint num = (nint)typeof(IntConnectionSO);
		nint num2 = (nint)connectionSO;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v42 @ r9_v2 (Il2CppClass<Kamgam.SettingsGenerator.IntConnectionSO>)+130]");
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v44 @ r10_v2 (Il2CppClass<Kamgam.SettingsGenerator.ConnectionSO>)+130]");
		nint num3 = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v42 @ r9_v2 (Il2CppClass<Kamgam.SettingsGenerator.IntConnectionSO>)+130]");
		IntConnectionSO intConnectionSO;
		if (num3 >= 0)
		{
			...
			bool flag = 0 == (nint)typeof(IntConnectionSO);
			intConnectionSO = (IntConnectionSO)1;
			if (flag)
			{
				goto IL_012b;
			}
		}
		intConnectionSO = null;
		goto IL_012b;
		IL_012b:
		bool flag2 = (object)intConnectionSO == null;
		ConnectionSO connectionObject = null;
		if (!flag2)
		{
			connectionObject = connectionSO;
		}
		IntConnectionSO intConnectionSO2;
		do
		{
			ConnectionObject = (IntConnectionSO)connectionObject;
			nint num4 = (nint)typeof(IntConnectionSO);
			nint num5 = (nint)connectionSO;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v66 @ r9_v3 (Il2CppClass<Kamgam.SettingsGenerator.IntConnectionSO>)+130]");
			object obj3 = 0;
			...
			if (num6 >= 0)
			{
				...
				bool flag3 = 0 == (nint)typeof(IntConnectionSO);
				intConnectionSO2 = (IntConnectionSO)1;
				if (flag3)
				{
					continue;
				}
			}
			intConnectionSO2 = null;
		}
		while ((object)intConnectionSO2 != null);
	}
	...
	public override void SetValue(int value, bool propagateChange = true)
	{
		...
		{
			OnChanged();
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.SettingInt)+20]");
			if ((nint)0 != 0)
			{
				PushToConnection();
			}
	...
	public SettingInt(string path, int value, List<string> groups = null)
	{
		...
		nint num = (nint)this;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v40 @ r9_v2 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+4E8]");
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v40 @ r9_v2 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+4F0]");
		object obj2 = 0;
	...
	protected override void triggerOnSettingChanged()
	{
		...
		Action<SettingInt> onSettingIntChanged = this.m_OnSettingIntChanged;
		if (this.m_OnSettingIntChanged != null)
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Indirect call: [v31 @ rcx_v3 (System.Action`1<Kamgam.SettingsGenerator.SettingInt>)+18] (should have been resolved before IL gen)");
		}
	...
	public override void ResetToDefault()
	{
		...
		nint num = (nint)this;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v2 @ r9_v1 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+4F0]");
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.SettingInt)+30]");
		SetValue(0);
		if (HasConnection())
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.SettingInt)+20]");
			...
			{
				nint num2 = (nint)this;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v50 @ rdx_v4 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+5D8]");
				object obj2 = 0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v50 @ rdx_v4 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+5E0]");
				object obj3 = 0;
	...
	public override void SetValueFromObject(object value, bool propagateChange = true)
	{
		...
		if (num2 == 0)
		{
			...
			object obj2 = obj3;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v58 @ r9_v3 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+4E8]");
			object obj4 = 0;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v58 @ r9_v3 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+4F0]");
			object obj5 = 0;
	...
	public override SettingData SerializeValueToData()
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.SettingInt)+18]");
		settingData.ID = (string)0;
		settingData.Type = SettingData.DataType.Int;
		int[] array = new int[1];
		int value = GetValue();
		if (array.Length > 0)
		{
	...
	public override void PullFromConnection()
	{
		...
		nint num = (nint)this;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v0 @ r8_v1 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+5B8]");
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v0 @ r8_v1 (Il2CppClass<Kamgam.SettingsGenerator.SettingInt>)+5C0]");
		object obj2 = 0;
