...
public class BeautifyChromaticAberrationConnection : Connection<float>
{
	...
	public override float Get()
	{
		...
		if (beautify != null)
		{
			FloatParameter chromaticAberrationIntensity = beautify.chromaticAberrationIntensity;
			nint num = (nint)chromaticAberrationIntensity;
			float value = chromaticAberrationIntensity.value;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @18038AA80");
			object obj = default(object);
			if (obj == null)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804B520Bh\"");
				Vector2 outputRange = _outputRange;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyChromaticAberrationConnection)+34]");
		...
		if (System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref obj2) <= System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref (object)num2))
		{
			if (num2 > 1f)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyChromaticAberrationConnection)+2C]");
	...
	public override void Set(float uiValue)
	{
		...
		if (obj == null)
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804B5362h\"");
		...
		goto IL_01bf;
		IL_01bf:
		beautify.chromaticAberrationIntensity.value = (float)vector;
		beautify.chromaticAberrationIntensity.overrideState = true;
