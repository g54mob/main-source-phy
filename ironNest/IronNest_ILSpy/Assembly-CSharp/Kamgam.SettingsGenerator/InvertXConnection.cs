...
public class InvertXConnection : Connection<bool>
{
	private readonly string _targetTag;

	private FirstPersonController _cachedController;

	public InvertXConnection(string targetTag)
	{
	...
	public override bool Get()
	{
		...
		if (Application.isPlaying)
		{
			...
			if (firstPersonController != null)
			{
				...
				{
					return firstPersonController.invertXCamera;
				}
	...
	public override void Set(bool uiValue)
	{
		if (Application.isPlaying)
		{
			...
			if (firstPersonController != null)
			{
				firstPersonController.invertXCamera = uiValue;
