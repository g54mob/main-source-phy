...
public class BeautifyBloomIntensityConnection : Connection<float>
{
	...
	public BeautifyBloomIntensityConnection(Vector2 inputRange, Vector2 outputRange, bool resolveEveryAccess, bool logWarnings)
	{
	...
	public override float Get()
	{
		...
		if (beautify != null)
		{
			FloatParameter bloomIntensity = beautify.bloomIntensity;
			nint num = (nint)bloomIntensity;
			float value = bloomIntensity.value;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @18038AA80");
			object obj = default(object);
			if (obj == null)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804B4ACBh\"");
				Vector2 outputRange = _outputRange;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyBloomIntensityConnection)+34]");
		...
		if (System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref obj2) <= System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref (object)num2))
		{
			if (num2 > 1f)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyBloomIntensityConnection)+2C]");
	...
	public override void Set(float uiValue)
	{
		...
		if (obj == null)
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804B4C22h\"");
		...
		goto IL_01bf;
		IL_01bf:
		beautify.bloomIntensity.value = (float)vector;
		beautify.bloomIntensity.overrideState = true;
