...
public class BeautifyVignetteOuterRingConnection : Connection<float>
{
	...
	public BeautifyVignetteOuterRingConnection(Vector2 inputRange, Vector2 outputRange, bool resolveEveryAccess, bool logWarnings)
	{
		...
		BeautifyConnectionResolver resolver = new BeautifyConnectionResolver(resolveEveryAccess, logWarnings2);
		_resolver = resolver;
	}
	...
	public override float Get()
	{
		...
		if (beautify != null)
		{
			ClampedFloatParameter vignettingOuterRing = beautify.vignettingOuterRing;
			nint num = (nint)vignettingOuterRing;
			float value = vignettingOuterRing.value;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @18038AA80");
			object obj = default(object);
			if (obj == null)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804CA93Bh\"");
				Vector2 outputRange = _outputRange;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyVignetteOuterRingConnection)+34]");
		...
		if (System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref obj2) <= System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref (object)num2))
		{
			if (num2 > 1f)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyVignetteOuterRingConnection)+2C]");
	...
	public override void Set(float uiValue)
	{
		...
		if (obj == null)
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804CAA92h\"");
		...
		goto IL_01bf;
		IL_01bf:
		beautify.vignettingOuterRing.value = (float)vector;
		beautify.vignettingOuterRing.overrideState = true;
