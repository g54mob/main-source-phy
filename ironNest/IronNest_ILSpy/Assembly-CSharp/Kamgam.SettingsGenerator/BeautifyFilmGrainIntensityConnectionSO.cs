...
public class BeautifyFilmGrainIntensityConnectionSO : FloatConnectionSO
{
	...
	public override IConnection<float> GetConnection()
	{
		...
		if (_connection == null)
		{
			BeautifyFilmGrainIntensityConnection beautifyFilmGrainIntensityConnection = (BeautifyFilmGrainIntensityConnection)new Connection<float>();
			Vector2 inputRange = InputRange;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyFilmGrainIntensityConnectionSO)+1C]");
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyFilmGrainIntensityConnectionSO)+24]");
			...
			beautifyFilmGrainIntensityConnection._inputRange = inputRange2;
			beautifyFilmGrainIntensityConnection._outputRange = outputRange2;
			beautifyFilmGrainIntensityConnection._autoToggleEnabled = AutoToggleEnabled;
			...
			beautifyFilmGrainIntensityConnection._resolver = beautifyConnectionResolver;
			_connection = beautifyFilmGrainIntensityConnection;
			return _connection;
		}
		return _connection;
	}
	...
	{
		BeautifyFilmGrainIntensityConnection connection = _connection;
		if (_connection != null)
		{
	...
	public BeautifyFilmGrainIntensityConnectionSO()
	{
