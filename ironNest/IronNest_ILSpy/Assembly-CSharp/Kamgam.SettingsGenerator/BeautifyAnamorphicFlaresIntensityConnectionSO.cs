...
public class BeautifyAnamorphicFlaresIntensityConnectionSO : FloatConnectionSO
{
	...
	public override IConnection<float> GetConnection()
	{
		...
		if (_connection == null)
		{
			BeautifyAnamorphicFlaresIntensityConnection beautifyAnamorphicFlaresIntensityConnection = (BeautifyAnamorphicFlaresIntensityConnection)new Connection<float>();
			Vector2 inputRange = InputRange;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyAnamorphicFlaresIntensityConnectionSO)+1C]");
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyAnamorphicFlaresIntensityConnectionSO)+24]");
			...
			beautifyAnamorphicFlaresIntensityConnection._inputRange = inputRange2;
			beautifyAnamorphicFlaresIntensityConnection._outputRange = outputRange2;
			...
			beautifyAnamorphicFlaresIntensityConnection._resolver = beautifyConnectionResolver;
			_connection = beautifyAnamorphicFlaresIntensityConnection;
			return _connection;
		}
		return _connection;
	}
	...
	{
		BeautifyAnamorphicFlaresIntensityConnection connection = _connection;
		if (_connection != null)
		{
	...
	public BeautifyAnamorphicFlaresIntensityConnectionSO()
	{
