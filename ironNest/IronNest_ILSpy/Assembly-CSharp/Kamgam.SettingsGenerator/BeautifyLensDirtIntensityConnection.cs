...
public class BeautifyLensDirtIntensityConnection : Connection<float>
{
	...
	public BeautifyLensDirtIntensityConnection(Vector2 inputRange, Vector2 outputRange, bool resolveEveryAccess, bool logWarnings)
	{
	...
	public override float Get()
	{
		...
		if (beautify != null)
		{
			FloatParameter lensDirtIntensity = beautify.lensDirtIntensity;
			nint num = (nint)lensDirtIntensity;
			float value = lensDirtIntensity.value;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @18038AA80");
			object obj = default(object);
			if (obj == null)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804B60CBh\"");
				Vector2 outputRange = _outputRange;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyLensDirtIntensityConnection)+34]");
		...
		if (System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref obj2) <= System.Runtime.CompilerServices.Unsafe.As<object, UIntPtr>(ref (object)num2))
		{
			if (num2 > 1f)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [this @ rcx (Kamgam.SettingsGenerator.BeautifyLensDirtIntensityConnection)+2C]");
	...
	public override void Set(float uiValue)
	{
		...
		if (obj == null)
		{
			Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"jp short 00000001804B6222h\"");
		...
		goto IL_01bf;
		IL_01bf:
		beautify.lensDirtIntensity.value = (float)vector;
		beautify.lensDirtIntensity.overrideState = true;
