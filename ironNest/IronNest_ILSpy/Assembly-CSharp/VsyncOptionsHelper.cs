...
public class VsyncOptionsHelper : MonoBehaviour
{
	private sealed class _003CDelayedSet_003Ed__4 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		private bool MoveNext()
		{
			...
			VsyncOptionsHelper vsyncOptionsHelper = _003C_003E4__this;
			...
			if (!flag)
			{
				...
				if (!flag)
				{
					...
					if (!flag)
					{
						if ((nint)obj2 == 1)
						{
							...
							if ((object)_003C_003E4__this == null || (object)vsyncOptionsHelper._resolver == null)
							{
								goto IL_0278;
							}
							vsyncOptionsHelper._resolver.Refresh();
						}
						return false;
					}
					_003C_003E1__state = -1;
				...
				else
				{
					...
					if (!(vsyncOptionsHelper._settingsProvider != null))
					{
				...
				if ((object)_003C_003E4__this != null && (object)vsyncOptionsHelper._settingsProvider != null)
				{
					Settings settings = vsyncOptionsHelper._settingsProvider.Settings;
					if ((object)settings != null)
					{
						SettingBool settingBool = settings.GetBool(vsyncOptionsHelper.id);
						...
						if (targetFrameRate > 0)
						{
							...
							settingBool.SetValue(value: false);
						}
