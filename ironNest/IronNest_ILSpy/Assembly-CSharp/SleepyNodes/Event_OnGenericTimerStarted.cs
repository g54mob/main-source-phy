...
public class Event_OnGenericTimerStarted : EventNode
{
	...
	protected override bool ShouldRun(EventData data)
	{
		...
		if (data != null)
		{
			nint num = (nint)typeof(EventData_GenericTimerStarted);
			nint num2 = (nint)data;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v40 @ rdx_v2 (Il2CppClass<EventData_GenericTimerStarted>)+130]");
			object obj = 0;
			...
			if (num3 >= 0)
			{
				...
				object obj2 = 0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v62 @ rax_v5+FFFFFFF8+v42 @ rax_v4*8]");
				if (0 == (nint)typeof(EventData_GenericTimerStarted))
				{
	...
	public Event_OnGenericTimerStarted()
	{
		EnableOnStart = true;
