...
public class State_End : StateNode
{
	...
	public override void OnEnter(NodeExecutionState state)
	{
		...
		{
			base.OnEnter(state);
			MissionManager._003CInstance_003Ek__BackingField.MarkMissionComplete();
			...
			{
				((MissionGraphNotificationListener)obj)?.Trigger("MissionComplete");
				obj2++;
				obj += 8;
				obj3 = obj2;
			}
			nint num = (nint)this;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v234 @ r9_v1 (Il2CppClass<SleepyNodes.State_End>)+218]");
			object obj4 = 0;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v234 @ r9_v1 (Il2CppClass<SleepyNodes.State_End>)+220]");
			object obj5 = 0;
