...
public class Event_OnMissionFailed : EventNode
{
	...
	protected override bool ShouldRun(EventData data)
	{
		...
		if (data != null)
		{
			nint num = (nint)typeof(EventData_MissionFailed);
			nint num2 = (nint)data;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v37 @ rdx_v2 (Il2CppClass<EventData_MissionFailed>)+130]");
			object obj = 0;
			...
			if (num3 >= 0)
			{
				...
				if (0 == (nint)typeof(EventData_MissionFailed))
				{
					return true;
				}
			}
