...
public class State_ClearTeleprinter : StateNode
{
	...
	public override void OnExecute(NodeExecutionState state)
	{
		...
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [182B3A7AA]");
		if ((nint)0 == 0)
		{
			_ = 1;
		}
		nint num = (nint)this;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v30 @ r9_v1 (Il2CppClass<SleepyNodes.State_ClearTeleprinter>)+218]");
		object obj = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v30 @ r9_v1 (Il2CppClass<SleepyNodes.State_ClearTeleprinter>)+220]");
		object obj2 = 0;
		Cpp2ILHelpers.NoteDecompilerIssue("Indirect jump: v34 @ rax_v2 (should have been resolved before IL gen)");
		/*Error: End of method reached without returning.*/;
	}

	unsafe static State_ClearTeleprinter()
	{
