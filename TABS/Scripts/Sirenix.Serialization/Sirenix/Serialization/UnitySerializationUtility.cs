...
namespace Sirenix.Serialization
{
	public static class UnitySerializationUtility
	{
		...
		{
			if (!(member is FieldInfo fieldInfo) || fieldInfo.IsStatic)
			{
				return false;
			}
		...
		public static void SerializeUnityObject(UnityEngine.Object unityObject, ref byte[] bytes, ref List<UnityEngine.Object> referencedUnityObjects, DataFormat format, bool serializeUnityFields = false, SerializationContext context = null)
		{
			...
			using (Sirenix.Serialization.Utilities.Cache<CachedMemoryStream> cache = Sirenix.Serialization.Utilities.Cache<CachedMemoryStream>.Claim())
			{
				using (Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver> cache2 = Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver>.Claim())
				{
					...
					{
						using (Sirenix.Serialization.Utilities.Cache<SerializationContext> cache4 = Sirenix.Serialization.Utilities.Cache<SerializationContext>.Claim())
						{
		...
		public static void DeserializeUnityObject(UnityEngine.Object unityObject, ref byte[] bytes, ref List<UnityEngine.Object> referencedUnityObjects, DataFormat format, DeserializationContext context = null)
		{
			...
			using (Sirenix.Serialization.Utilities.Cache<CachedMemoryStream> cache = Sirenix.Serialization.Utilities.Cache<CachedMemoryStream>.Claim())
			{
				using (Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver> cache2 = Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver>.Claim())
				{
					...
					using (Sirenix.Serialization.Utilities.Cache<DeserializationContext> cache4 = Sirenix.Serialization.Utilities.Cache<DeserializationContext>.Claim())
					{
						cache4.Value.Config.SerializationPolicy = SerializationPolicies.Unity;
						if (GlobalConfig<GlobalSerializationConfig>.HasInstanceLoaded)
						{
		...
		public static List<string> SerializePrefabModifications(List<PrefabModification> modifications, ref List<UnityEngine.Object> referencedUnityObjects)
		{
			...
			using (Sirenix.Serialization.Utilities.Cache<SerializationContext> cache = Sirenix.Serialization.Utilities.Cache<SerializationContext>.Claim())
			{
				...
				{
					using (Sirenix.Serialization.Utilities.Cache<JsonDataWriter> cache3 = Sirenix.Serialization.Utilities.Cache<JsonDataWriter>.Claim())
					{
						using (Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver> cache4 = Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver>.Claim())
						{
		...
		public static List<PrefabModification> DeserializePrefabModifications(List<string> modifications, List<UnityEngine.Object> referencedUnityObjects)
		{
			...
			using (Sirenix.Serialization.Utilities.Cache<DeserializationContext> cache = Sirenix.Serialization.Utilities.Cache<DeserializationContext>.Claim())
			{
				...
				{
					using (Sirenix.Serialization.Utilities.Cache<JsonDataReader> cache3 = Sirenix.Serialization.Utilities.Cache<JsonDataReader>.Claim())
					{
						using (Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver> cache4 = Sirenix.Serialization.Utilities.Cache<UnityReferenceResolver>.Claim())
						{
		...
		private static ICache GetCachedUnityWriter(DataFormat format, Stream stream, SerializationContext context)
		{
			...
			{
				Sirenix.Serialization.Utilities.Cache<BinaryDataWriter> cache3 = Sirenix.Serialization.Utilities.Cache<BinaryDataWriter>.Claim();
			...
			{
				Sirenix.Serialization.Utilities.Cache<JsonDataWriter> cache = Sirenix.Serialization.Utilities.Cache<JsonDataWriter>.Claim();
		...
		private static ICache GetCachedUnityReader(DataFormat format, Stream stream, DeserializationContext context)
		{
			...
			case DataFormat.Binary:
			{
				Sirenix.Serialization.Utilities.Cache<BinaryDataReader> cache3 = Sirenix.Serialization.Utilities.Cache<BinaryDataReader>.Claim();
				cache3.Value.Stream = stream;
				cache2 = cache3;
				break;
			}
			case DataFormat.JSON:
			{
				Sirenix.Serialization.Utilities.Cache<JsonDataReader> cache = Sirenix.Serialization.Utilities.Cache<JsonDataReader>.Claim();
				cache.Value.Stream = stream;
				cache2 = cache;
				break;
			}
