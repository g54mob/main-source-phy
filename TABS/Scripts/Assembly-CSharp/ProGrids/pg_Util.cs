...
namespace ProGrids
{
	public static class pg_Util
	{
		...
		public static Vector3 SnapValue(Vector3 val, float snapValue)
		{
			float x = val.x;
			float y = val.y;
			return new Vector3(z: Snap(val.z, snapValue), x: Snap(x, snapValue), y: Snap(y, snapValue));
		}
		...
		public static Vector3 SnapToFloor(Vector3 val, float snapValue)
		{
			float x = val.x;
			float y = val.y;
			return new Vector3(z: SnapToFloor(val.z, snapValue), x: SnapToFloor(x, snapValue), y: SnapToFloor(y, snapValue));
		}
