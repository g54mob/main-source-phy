...
namespace ModIO.UI
{
	...
	public class UserView : MonoBehaviour
	{
		...
		{
			IUserViewElement[] componentsInChildren = base.gameObject.GetComponentsInChildren<IUserViewElement>(includeInactive: true);
			for (int i = 0; i < componentsInChildren.Length; i++)
			{
				componentsInChildren[i].SetUserView(this);
			}
		}
