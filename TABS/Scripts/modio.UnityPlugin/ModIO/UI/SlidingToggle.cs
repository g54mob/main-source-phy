	...
	public class SlidingToggle : Toggle
	{
		...
		public SlideAxis slideAxis
		{
			...
			set
			{
				...
				{
					m_slideAxis = value;
					UpdateContentPosition(animate: true);
				}
			}
		}
		...
		{
			yield return null;
			UpdateContentPosition(animate: false);
		}
		...
		{
			Vector2 anchoredPosition = m_slideContent.anchoredPosition;
			float elapsed = 0f;
			...
			while (elapsed < factoredDuration)
			{
				...
				m_slideContent.anchoredPosition = anchoredPosition;
