...
namespace ModIO.UI
{
	...
	public class ClickOffCatcher : MonoBehaviour
	{
		...
		public static RectTransform InstantiateBlocker(RectTransform creator)
		{
			...
			GameObject obj = new GameObject("Blocker", typeof(RectTransform))
			{
			...
			Canvas canvas2 = obj.AddComponent<Canvas>();
			canvas2.overridePixelPerfect = false;
			canvas2.overrideSorting = true;
			canvas2.sortingOrder = 29999;
			canvas2.additionalShaderChannels = AdditionalCanvasShaderChannels.None;
			...
			obj.AddComponent<Button>().navigation = new Navigation
			{
