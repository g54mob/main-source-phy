...
namespace ModIO.UI
{
	...
	public class DownloadDisplay : DownloadDisplayComponent
	{
		...
		public override void DisplayDownload(FileDownloadInfo downloadInfo)
		{
			...
			long bytesReceived = (long)((downloadInfo.request == null) ? 0 : downloadInfo.request.downloadedBytes);
		...
		private IEnumerator UpdateCoroutine()
		{
			...
			long timeStepStartByteCount = (long)((m_downloadInfo.request == null) ? 0 : m_downloadInfo.request.downloadedBytes);
