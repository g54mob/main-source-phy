...
namespace ModIO.UI
{
	...
	public struct GenericTextComponent
	{
		...
		public Component displayComponent => m_textDisplayComponent;
		...
		public static Component FindCompatibleTextComponent(GameObject gameObject)
		{
			...
			if (gameObject != null)
			{
				...
				{
					PropertyInfo property = component.GetType().GetProperty("text", BindingFlags.IgnoreCase | BindingFlags.Instance | BindingFlags.Public);
