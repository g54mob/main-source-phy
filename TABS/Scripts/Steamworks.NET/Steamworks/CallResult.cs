...
namespace Steamworks
{
	public sealed class CallResult<T> : IDisposable, ICallback
	{
		...
		public void OnRunCallback(IntPtr thisptr, IntPtr pvParam)
		{
			m_hAPICall = SteamAPICall_t.Invalid;
			try
			{
		...
		public void OnRunCallResult(IntPtr thisptr, IntPtr pvParam, bool bFailed, ulong hSteamAPICall_)
		{
		...
		public int OnGetCallbackSizeBytes(IntPtr thisptr)
		{
			return m_size;
		}
