...
namespace Backtrace.Unity.Model
{
	public class BacktraceResult
	{
		...
		public static BacktraceResult FromJson(string json)
		{
			...
			return new BacktraceResult
			{
				response = backtraceRawResult.response,
				_rxId = backtraceRawResult._rxid,
				Status = ((!(backtraceRawResult.response == "ok")) ? BacktraceResultStatus.ServerError : BacktraceResultStatus.Ok)
			};
		}
	}
}
