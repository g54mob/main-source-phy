...
{
	internal sealed class ValueTupleFormatter<T1> : IFormatter<ValueTuple<T1>>, IFormatter
	{
		...
		public void Deserialize(byte[] buffer, ref int offset, ref ValueTuple<T1> value)
		{
			...
			value = new ValueTuple<T1>(value2);
		}
	}
	internal sealed class ValueTupleFormatter<T1, T2> : IFormatter<(T1, T2)>, IFormatter
	{
		private IFormatter<T1> _item1Formatter;

		private IFormatter<T2> _item2Formatter;

		public void Serialize(ref byte[] buffer, ref int offset, (T1, T2) value)
		{
			_item1Formatter.Serialize(ref buffer, ref offset, value.Item1);
			_item2Formatter.Serialize(ref buffer, ref offset, value.Item2);
		}

		public void Deserialize(byte[] buffer, ref int offset, ref (T1, T2) value)
		{
			T1 value2 = default(T1);
	...
	internal sealed class ValueTupleFormatter<T1, T2, T3> : IFormatter<(T1, T2, T3)>, IFormatter
	{
		private IFormatter<T1> _item1Formatter;
		...
		public void Serialize(ref byte[] buffer, ref int offset, (T1, T2, T3) value)
		{
			_item1Formatter.Serialize(ref buffer, ref offset, value.Item1);
			_item2Formatter.Serialize(ref buffer, ref offset, value.Item2);
		...
		public void Deserialize(byte[] buffer, ref int offset, ref (T1, T2, T3) value)
		{
			T1 value2 = default(T1);
			T2 value3 = default(T2);
	...
	internal sealed class ValueTupleFormatter<T1, T2, T3, T4> : IFormatter<(T1, T2, T3, T4)>, IFormatter
	{
		private IFormatter<T1> _item1Formatter;
		...
		public void Serialize(ref byte[] buffer, ref int offset, (T1, T2, T3, T4) value)
		{
			_item1Formatter.Serialize(ref buffer, ref offset, value.Item1);
			_item2Formatter.Serialize(ref buffer, ref offset, value.Item2);
			_item3Formatter.Serialize(ref buffer, ref offset, value.Item3);
		...
		public void Deserialize(byte[] buffer, ref int offset, ref (T1, T2, T3, T4) value)
		{
			T1 value2 = default(T1);
			T2 value3 = default(T2);
			T3 value4 = default(T3);
	...
	internal sealed class ValueTupleFormatter<T1, T2, T3, T4, T5> : IFormatter<(T1, T2, T3, T4, T5)>, IFormatter
	{
		private IFormatter<T1> _item1Formatter;
		...
		public void Serialize(ref byte[] buffer, ref int offset, (T1, T2, T3, T4, T5) value)
		{
			_item1Formatter.Serialize(ref buffer, ref offset, value.Item1);
			_item2Formatter.Serialize(ref buffer, ref offset, value.Item2);
			_item3Formatter.Serialize(ref buffer, ref offset, value.Item3);
		...
		public void Deserialize(byte[] buffer, ref int offset, ref (T1, T2, T3, T4, T5) value)
		{
			T1 value2 = default(T1);
			T2 value3 = default(T2);
			T3 value4 = default(T3);
	...
	internal sealed class ValueTupleFormatter<T1, T2, T3, T4, T5, T6> : IFormatter<(T1, T2, T3, T4, T5, T6)>, IFormatter
	{
		private IFormatter<T1> _item1Formatter;
		...
		public void Serialize(ref byte[] buffer, ref int offset, (T1, T2, T3, T4, T5, T6) value)
		{
			_item1Formatter.Serialize(ref buffer, ref offset, value.Item1);
			_item2Formatter.Serialize(ref buffer, ref offset, value.Item2);
			_item3Formatter.Serialize(ref buffer, ref offset, value.Item3);
		...
		public void Deserialize(byte[] buffer, ref int offset, ref (T1, T2, T3, T4, T5, T6) value)
		{
			T1 value2 = default(T1);
			T2 value3 = default(T2);
			T3 value4 = default(T3);
	...
	internal sealed class ValueTupleFormatter<T1, T2, T3, T4, T5, T6, T7> : IFormatter<(T1, T2, T3, T4, T5, T6, T7)>, IFormatter
	{
		private IFormatter<T1> _item1Formatter;
		...
		public void Serialize(ref byte[] buffer, ref int offset, (T1, T2, T3, T4, T5, T6, T7) value)
		{
			_item1Formatter.Serialize(ref buffer, ref offset, value.Item1);
			_item2Formatter.Serialize(ref buffer, ref offset, value.Item2);
			_item3Formatter.Serialize(ref buffer, ref offset, value.Item3);
		...
		public void Deserialize(byte[] buffer, ref int offset, ref (T1, T2, T3, T4, T5, T6, T7) value)
		{
			T1 value2 = default(T1);
			T2 value3 = default(T2);
			T3 value4 = default(T3);
	...
	internal sealed class ValueTupleFormatter<T1, T2, T3, T4, T5, T6, T7, TRest> : IFormatter<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IFormatter where TRest : struct
	{
		private IFormatter<T1> _item1Formatter;
		...
		public void Deserialize(byte[] buffer, ref int offset, ref ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> value)
		{
			...
			value = new ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>(value2, value3, value4, value5, value6, value7, value8, value9);
		}
	}
}
