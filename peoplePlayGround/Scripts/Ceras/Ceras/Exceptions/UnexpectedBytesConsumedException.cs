namespace Ceras.Exceptions
{
	public class UnexpectedBytesConsumedException : CerasException
	{
		...
		public UnexpectedBytesConsumedException(string message, int bytesExpectedToRead, int bytesActuallyRead, int offsetBeforeDeserialize, int offsetAfterDeserialize)
			: base(message)
		{
