...
public class WinchBehaviour : MonoBehaviour, Messages.IUse
{
	...
	private void UpdateWinchLimits()
	{
		...
		{
			min = (flag ? (0f - UpperLimit) : LowerLimit) / 0.82397f,
			max = (flag ? (0f - LowerLimit) : UpperLimit) / 0.82397f
		};
		LimitGizmo.SetPosition(0, new Vector3(LowerLimit / 0.82397f, 0f, 0f));
		LimitGizmo.SetPosition(1, new Vector3(UpperLimit / 0.82397f, 0f, 0f));
	}
