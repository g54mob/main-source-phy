...
public class BalloonBehaviour : MonoBehaviour, Messages.IExitShot, Messages.IShot, Messages.IStabbed, Messages.IBreak, Messages.IOnFragmentHit, Messages.IOnInsideVacuum
{
	[SkipSerialisation]
