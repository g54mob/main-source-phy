...
public struct IgnoreCollisionStackController
{
	private struct ColliderPair
	{
		...
		{
			if (obj is ColliderPair colliderPair)
			{
		...
		public override int GetHashCode()
		{
			...
			return (-1817952719 * -1521134295 + Mathf.Max(hashCode, hashCode2)) * -1521134295 + Mathf.Min(hashCode, hashCode2);
		}
	...
	public static event Action<Collider2D, Collider2D> OnRequestIgnore;

	public static event Action<Collider2D, Collider2D> OnRequestDoNotIgnore;
	...
	public static void RequestIgnoreCollision(Collider2D a, Collider2D b)
	{
		if ((bool)a && (bool)b)
		{
			...
			if (IgnoreCollisionStackController.OnRequestIgnore != null)
			{
				IgnoreCollisionStackController.OnRequestIgnore(a, b);
			}
		}
	}
	...
	public static void RequestDontIgnoreCollision(Collider2D a, Collider2D b)
	{
		...
		if (IgnoreCollisionStackController.OnRequestDoNotIgnore != null)
		{
			IgnoreCollisionStackController.OnRequestDoNotIgnore(a, b);
		}
	}
	...
	static IgnoreCollisionStackController()
	{
		IgnoreCollisionStackController.OnRequestIgnore = null;
		IgnoreCollisionStackController.OnRequestDoNotIgnore = null;
	}
}
