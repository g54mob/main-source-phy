...
public class HoverThrusterBehaviour : MonoBehaviour, Messages.IUse
{
	...
	public const float MinHeight = 0.6068182f;

	public const float MaxHeight = 12136.364f;
	...
	private void Start()
	{
		...
		{
			Utils.OpenFloatInputDialog(BaseHoverHeight * 0.82397f, this, delegate(HoverThrusterBehaviour t, float v)
			{
				t.BaseHoverHeight = Mathf.Clamp(v * 1.2136364f, 0.6068182f, 12136.364f);
	...
	public void Use(ActivationPropagation a)
	{
		if (base.enabled)
		{
			...
			BaseHoverHeight = Mathf.Clamp(BaseHoverHeight, 0.6068182f, 12136.364f);
		}
	}
