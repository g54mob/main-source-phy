...
public readonly struct DamagePoint : IEquatable<DamagePoint>
{
	...
	{
		return (((252580816 * -1521134295 + X.GetHashCode()) * -1521134295 + Y.GetHashCode()) * -1521134295 + Intensity.GetHashCode()) * -1521134295 + Type.GetHashCode();
	}
