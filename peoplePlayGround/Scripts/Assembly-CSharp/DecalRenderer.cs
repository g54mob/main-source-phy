...
public class DecalRenderer : MonoBehaviour, Messages.IDecal
{
	...
	private void Start()
	{
		...
		{
			Debug.LogErrorFormat("{0} without a parent... This is not allowed.", "DecalRenderer");
			base.enabled = false;
			return;
		}
		for (int i = 0; i < 32; i++)
	...
	public void Decal(DecalInstruction d)
	{
		...
		Matrix4x4 value = new Matrix4x4
		{
			...
			m01 = vector.y,
			m02 = 0.4f,
			m10 = d.colourMultiplier.r * DecalType.Color.r,
			m11 = d.colourMultiplier.g * DecalType.Color.g,
			m12 = d.colourMultiplier.b * DecalType.Color.b,
			m13 = d.colourMultiplier.a * DecalType.Color.a,
			m20 = num2
		};
		CurrentDecalAmount++;
