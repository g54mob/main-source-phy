...
public class Messages
{
	...
	public interface ILasered
	{
		public struct LaserArgs
		{
			public LaserBehaviour Laser;

			public Utils.LaserHit Hit;

			public LaserArgs(LaserBehaviour laser, Utils.LaserHit hit)
			{
				Laser = laser;
				Hit = hit;
			}
