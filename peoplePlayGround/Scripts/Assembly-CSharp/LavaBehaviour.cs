...
public class LavaBehaviour : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		for (int i = 0; i < num; i++)
		{
			...
			if (!collider2D || !Global.main.PhysicalObjectsInWorldByTransform.TryGetValue(collider2D.transform, out var value) || value.rigidbody.bodyType != RigidbodyType2D.Dynamic)
			{
				continue;
			}
