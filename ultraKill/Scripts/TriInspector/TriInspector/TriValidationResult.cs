...
namespace TriInspector
{
	...
	{
		public static TriValidationResult Valid => new TriValidationResult(valid: true, null, TriMessageType.None);
		...
		public TriValidationResult(bool valid, string message, TriMessageType messageType, Action fixAction = null, GUIContent fixActionContent = null)
		{
			IsValid = valid;
			Message = message;
		...
		{
			return new TriValidationResult(valid: false, error, TriMessageType.Info);
		}

		public static TriValidationResult Error(string error)
		{
			return new TriValidationResult(valid: false, error, TriMessageType.Error);
		}

		public static TriValidationResult Warning(string error)
		{
			return new TriValidationResult(valid: false, error, TriMessageType.Warning);
		}
	}
}
