...
namespace Vertx.Debugging
{
	...
	{
		public static readonly Color HitColor = new Color(1f, 0.1f, 0.2f);

		public static readonly Color CastColor = new Color(0.4f, 1f, 0.3f);

		public static readonly Color EnterColor = new Color(1f, 0.1f, 0.2f);
		...
		public static readonly Color XColor = new Color(1f, 0.1f, 0.2f);

		public static readonly Color YColor = new Color(0.3f, 1f, 0.1f);

		public static readonly Color ZColor = new Color(0.1f, 0.4f, 1f);
