...
public class ZombieMelee : EnemyScript, IHitTargetCallback
{
	...
	private void FixedUpdate()
	{
		...
		if (mach.grounded && !(nma == null) && nma.enabled && nma.isOnNavMesh)
		{
	...
	public void TrackTick()
	{
		...
		if (base.gameObject.activeInHierarchy && target != null && !(nma == null) && eid.enabled && mach.grounded && !mach.falling && !mach.knockedBack && !diving && !inAction && !mach.isOnOffNavmeshLink && !mach.isTraversingPortalLink)
		{
