...
public class VariationInfo : MonoBehaviour
{
	...
	public void UpdateMoney()
	{
		...
		equipStatusButton.interactable = true;
		...
		if ((bool)orderButtons)
		{
			if (equipStatus != 0)
			{
				...
				icon.rectTransform.anchoredPosition = new Vector2(25f, 0f);
				icon.rectTransform.sizeDelta = new Vector2(75f, 75f);
			}
			else
			{
	...
	private void SetEquipStatusText(int equipStatus)
	{
		...
		case 1:
			...
			break;
		case 2:
			equipText.SetText("Alternate");
			equipText.color = new Color(1f, 0.3f, 0.3f);
			break;
		}
	}
}
