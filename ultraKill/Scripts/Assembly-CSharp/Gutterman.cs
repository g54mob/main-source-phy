...
public class Gutterman : EnemyScript, IEnrage, IAlter, IAlterOptions<bool>
{
	...
	private void Update()
	{
		...
		{
			UnityEngine.Object.Destroy(currentEnrageEffect.gameObject);
		}
	}
	...
	private void AttackUpdate()
	{
		...
		{
			slowMode = false;
			UnityEngine.Object.Instantiate(releaseSound, position, Quaternion.identity);
		}
	...
	{
		if (eid.target != null && slowMode && windup >= 0.5f && (firing || windup >= 1f) && mach.gc.onGround && (nma == null || !nma.isOnOffMeshLink))
		{
			firing = true;
	...
	private void Death()
	{
		UnityEngine.Object.Instantiate(deathSound, base.transform);
		ShieldBashStop();
		dead = true;
		windupAud.Stop();
	...
	public void ShieldBreak(bool player = true, bool flash = true)
	{
		...
		hasShield = false;
		UnityEngine.Object.Instantiate(bonkSound, base.transform.position, Quaternion.identity);
