...
public class Guttertank : EnemyScript, IHitTargetCallback
{
	...
	private void PrepMine()
	{
		...
		UnityEngine.Object.Instantiate(minePrepSound, base.transform);
		inAction = true;
		nma.enabled = false;
		lookAtTarget = false;
		mineCooldown = UnityEngine.Random.Range(2f, 3f);
	...
	private void PrepRocket()
	{
		...
		UnityEngine.Object.Instantiate(rocketPrepSound, base.transform);
		inAction = true;
		nma.enabled = false;
		trackInAction = true;
		lookAtTarget = true;
	...
	private void Punch()
	{
		...
		UnityEngine.Object.Instantiate(punchPrepSound, base.transform);
	...
	{
		UnityEngine.Object.Instantiate(fallImpactSound, new Vector3(eid.weakPoint.transform.position.x, base.transform.position.y, eid.weakPoint.transform.position.z), Quaternion.identity);
		eid.hitter = "";
