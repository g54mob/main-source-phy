...
public class LeviathanHead : MonoBehaviour
{
	...
	private void Descend()
	{
		if (active)
		{
			...
			Object.Instantiate(biteWindupSound, tracker.position, Quaternion.identity, tracker).SetPitch(0.5f);
			recentAttacks = 0;
			previousAttack = -1;
		}
	}
	...
	private void BeamAttack()
	{
		if (active)
		{
			inAction = true;
			lcon.stopTail = true;
			anim.SetBool("BeamAttack", value: true);
			Object.Instantiate(beamWindupSound, tracker.position, Quaternion.identity, tracker);
			bodyRotationOverride = true;
	...
	private void BeamStop()
	{
		...
		anim.SetBool("BeamAttack", value: false);
	...
	public void GotParried()
	{
		...
		Object.Instantiate(hurtSound, tracker.position, Quaternion.identity, tracker);
