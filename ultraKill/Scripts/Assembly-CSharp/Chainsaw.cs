...
public class Chainsaw : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		...
		if (traversals.Count > 0)
		{
			...
			if (!nativePortalTransform.IsPointInFront(base.transform.position) && Vector3.Dot(nativePortalTransform.centerManaged - base.transform.position, nativePortalTransform.back) > 2f)
			{
				UnityEngine.Object.Destroy(base.gameObject);
				return;
			}
