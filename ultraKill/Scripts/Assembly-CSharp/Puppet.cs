...
public class Puppet : EnemyScript
{
	...
	private void SlowUpdate()
	{
		...
		if (eid.target != null && !inAction && nma.enabled && nma.isOnNavMesh && !mach.isTraversingPortalLink && Physics.Raycast(eid.target.position, Vector3.down, out var hitInfo, 120f, LayerMaskDefaults.Get(LMD.Environment)))
		{
