...
namespace PartyCSharpSDK
{
	public class PARTY_VOICE_CHAT_TRANSCRIPTION_RECEIVED_STATE_CHANGE : PARTY_STATE_CHANGE
	{
		...
		public PARTY_CHAT_CONTROL_HANDLE senderChatControl { get; set; }

		public List<PARTY_CHAT_CONTROL_HANDLE> receiverChatControls { get; set; }

		public PARTY_AUDIO_SOURCE_TYPE sourceType { get; set; }

		public string languageCode { get; set; }

		public string transcription { get; set; }

		public PARTY_VOICE_CHAT_TRANSCRIPTION_PHRASE_TYPE type { get; set; }

		public List<PARTY_TRANSLATION> translations { get; set; }
