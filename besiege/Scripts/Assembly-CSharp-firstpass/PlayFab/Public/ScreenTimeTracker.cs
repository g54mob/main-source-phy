...
namespace PlayFab.Public
{
	public class ScreenTimeTracker : IScreenTimeTracker
	{
		...
		public void ClientSessionStart(string entityId, string entityType, string playFabUserId)
		{
			...
			dictionary.Add("UserID", playFabUserId);
			dictionary.Add("DeviceType", SystemInfo.deviceType);
			dictionary.Add("DeviceModel", SystemInfo.deviceModel);
			dictionary.Add("OS", SystemInfo.operatingSystem);
			dictionary.Add("ClientSessionID", gameSessionID);
			Dictionary<string, object> payload = dictionary;
		...
		public void OnApplicationFocus(bool isFocused)
		{
			...
			Dictionary<string, object> dictionary = new Dictionary<string, object>();
			dictionary.Add("FocusID", focusId);
			dictionary.Add("FocusState", isFocused);
			dictionary.Add("FocusStateDuration", num);
			dictionary.Add("EventTimestamp", utcNow);
			dictionary.Add("ClientSessionID", gameSessionID);
			Dictionary<string, object> payload = dictionary;
