...
{
	public class SimpleJsonInstance : IPlayFabPlugin, ISerializerPlugin
	{
		public class PlayFabSimpleJsonCuztomization : PocoJsonSerializerStrategy
		{
			public override object DeserializeObject(object value, Type type)
			{
				...
				{
					DateTime result;
					if (DateTime.TryParseExact(text, PlayFabUtil._defaultDateTimeFormats, CultureInfo.InvariantCulture, PlayFabUtil.DateTimeStyles, out result))
					{
						return result;
					}
				}
				else if (type == typeof(DateTimeOffset))
				{
					...
					if (DateTimeOffset.TryParseExact(text, PlayFabUtil._defaultDateTimeFormats, CultureInfo.InvariantCulture, PlayFabUtil.DateTimeStyles, out result2))
					{
						return result2;
					}
				}
