...
namespace XGamingRuntime.Interop
{
	public static class Social
	{
		...
		[DllImport("Microsoft.Xbox.Services.141.GDK.C.Thunks", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		[return: NativeTypeName("HRESULT")]
		public unsafe static extern int XblSocialGetSocialRelationshipsResult(XAsyncBlockPtr async, [NativeTypeName("XblSocialRelationshipResultHandle *")] IntPtr* handle);

		[DllImport("Microsoft.Xbox.Services.141.GDK.C.Thunks", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		[return: NativeTypeName("HRESULT")]
		public unsafe static extern int XblSocialRelationshipResultGetRelationships([NativeTypeName("XblSocialRelationshipResultHandle")] IntPtr resultHandle, [NativeTypeName("const XblSocialRelationship **")] XblSocialRelationship** relationships, [NativeTypeName("size_t *")] SizeT* relationshipsCount);

		[DllImport("Microsoft.Xbox.Services.141.GDK.C.Thunks", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		[return: NativeTypeName("HRESULT")]
		public unsafe static extern int XblSocialRelationshipResultHasNext([NativeTypeName("XblSocialRelationshipResultHandle")] IntPtr resultHandle, bool* hasNext);

		[DllImport("Microsoft.Xbox.Services.141.GDK.C.Thunks", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		[return: NativeTypeName("HRESULT")]
		public unsafe static extern int XblSocialRelationshipResultGetTotalCount([NativeTypeName("XblSocialRelationshipResultHandle")] IntPtr resultHandle, [NativeTypeName("size_t *")] SizeT* totalCount);
		...
		[DllImport("Microsoft.Xbox.Services.141.GDK.C.Thunks", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		[return: NativeTypeName("HRESULT")]
		public unsafe static extern int XblSocialRelationshipResultGetNextResult(XAsyncBlockPtr async, [NativeTypeName("XblSocialRelationshipResultHandle *")] IntPtr* handle);

		[DllImport("Microsoft.Xbox.Services.141.GDK.C.Thunks", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
		[return: NativeTypeName("HRESULT")]
		public unsafe static extern int XblSocialRelationshipResultDuplicateHandle([NativeTypeName("XblSocialRelationshipResultHandle")] IntPtr handle, [NativeTypeName("XblSocialRelationshipResultHandle *")] IntPtr* duplicatedHandle);
