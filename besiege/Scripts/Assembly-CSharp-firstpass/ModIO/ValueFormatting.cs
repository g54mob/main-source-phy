	...
	public struct ValueFormatting
	{
		...
		public static string FormatValue(object value, Method method, string toStringParameter)
		{
			...
			case Method.ByteCount:
			{
				...
				empty = ByteCount(value2, toStringParameter);
				break;
			}
			case Method.AbbreviatedNumber:
			{
				...
				empty = AbbreviateInteger(value3, toStringParameter);
				break;
			}
			...
			default:
				...
				if (value != null && !string.IsNullOrEmpty(toStringParameter))
				{
					if (value is float)
					{
						empty = ((float)value).ToString(toStringParameter);
					}
					else if (value is int)
					{
						empty = ((int)value).ToString(toStringParameter);
					}
					else if (value is long)
					{
						empty = ((long)value).ToString(toStringParameter);
					}
				}
				if (empty == null)
				{
