...
namespace ModIO
{
	...
	{
		private static bool isPushingSubChanges;
		...
		public static void SubscribeToMod(int modId)
		{
			...
			bool flag2 = LocalUser.QueuedSubscribes.Contains(modId);
			if (flag)
			{
		...
		public static void AuthenticateWithSteamEncryptedAppTicket(byte[] pTicket, uint pcbTicket, bool hasUserAcceptedTerms, Action<UserProfile> onSuccess, Action<WebRequestError> onError)
		{
			...
			AuthenticateWithSteamEncryptedAppTicket(encodedTicket, hasUserAcceptedTerms, onSuccess, onError);
		}
		...
		public static void AuthenticateWithGOGEncryptedAppTicket(byte[] data, uint dataSize, bool hasUserAcceptedTerms, Action<UserProfile> onSuccess, Action<WebRequestError> onError)
		{
			...
			AuthenticateWithGOGEncryptedAppTicket(encodedTicket, hasUserAcceptedTerms, onSuccess, onError);
		}
		...
		{
			AuthenticateWithSteamEncryptedAppTicket(pTicket, pcbTicket, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithSteamEncryptedAppTicket(authTicketData, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithSteamEncryptedAppTicket(encodedTicket, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithGOGEncryptedAppTicket(data, dataSize, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithGOGEncryptedAppTicket(encodedTicket, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithItchIOToken(jwtToken, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithOculusRiftUserData(oculusUserNonce, oculusUserId, oculusUserAccessToken, false, onSuccess, onError);
		}
		...
		{
			AuthenticateWithXboxLiveToken(xboxLiveUserToken, false, onSuccess, onError);
		}

		[Obsolete("Now requires the hasUserAcceptedTerms flag to be provided.")]
		public static void ReauthenticateWithStoredExternalAuthData(Action<UserProfile> onSuccess, Action<WebRequestError> onError)
		{
			ReauthenticateWithStoredExternalAuthData(false, onSuccess, onError);
		}
	}
}
