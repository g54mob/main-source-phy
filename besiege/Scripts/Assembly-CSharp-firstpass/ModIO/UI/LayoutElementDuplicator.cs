	...
	public class LayoutElementDuplicator : UIBehaviour, ILayoutElement
	{
		...
		private bool CalcLayoutHorizontal_Internal()
		{
			...
			if (m_CopyMinWidth)
			{
				...
				{
					num = Mathf.Max(layoutElement.minWidth, num);
				}
			}
			float num2 = -1f;
			...
			{
				int num3 = -1;
				ILayoutElement[] layoutElementSources2 = m_layoutElementSources;
				foreach (ILayoutElement layoutElement2 in layoutElementSources2)
				{
					if (layoutElement2.layoutPriority > num3 && layoutElement2.preferredWidth >= 0f)
					{
						num2 = layoutElement2.preferredWidth;
					}
				}
			}
			float num4 = -1f;
			...
			{
				int num5 = -1;
				ILayoutElement[] layoutElementSources3 = m_layoutElementSources;
				foreach (ILayoutElement layoutElement3 in layoutElementSources3)
				{
					if (layoutElement3.layoutPriority > num5 && layoutElement3.flexibleWidth >= 0f)
					{
						num4 = layoutElement3.flexibleWidth;
					}
				}
			}
			bool flag = num != m_minWidth;
			flag |= num2 != m_preferredWidth;
			flag |= num4 != m_flexibleWidth;
			m_minWidth = num;
		...
		private bool CalcLayoutVertical_Internal()
		{
			...
			if (m_CopyMinHeight)
			{
				...
				foreach (ILayoutElement layoutElement in layoutElementSources)
				{
					num = Mathf.Max(layoutElement.minHeight, num);
				}
			}
			float num2 = -1f;
			if (m_CopyPreferredHeight)
			{
				...
				foreach (ILayoutElement layoutElement2 in layoutElementSources2)
				{
					if (layoutElement2.layoutPriority > num3 && layoutElement2.preferredHeight >= 0f)
					{
						num2 = layoutElement2.preferredHeight;
					}
				}
			}
			float num4 = -1f;
			if (m_CopyFlexibleHeight)
			{
				...
				foreach (ILayoutElement layoutElement3 in layoutElementSources3)
				{
					if (layoutElement3.layoutPriority > num5 && layoutElement3.flexibleHeight >= 0f)
					{
						num4 = layoutElement3.flexibleHeight;
					}
				}
			}
			bool flag = num != m_minHeight;
			flag |= num2 != m_preferredHeight;
			flag |= num4 != m_flexibleHeight;
			m_minHeight = num;
		...
		{
			bool flag = false;
			flag |= CalcLayoutHorizontal_Internal();
			if (flag | CalcLayoutVertical_Internal())
			{
				SetDirty();
			}
		}
