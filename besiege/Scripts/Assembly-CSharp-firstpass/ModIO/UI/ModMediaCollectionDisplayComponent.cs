...
namespace ModIO.UI
{
	...
	public abstract class ModMediaCollectionDisplayComponent : MonoBehaviour
	{
		...
		public abstract void DisplayMedia(int modId, LogoImageLocator logoLocator, IEnumerable<GalleryImageLocator> galleryImageLocators, IEnumerable<string> youTubeURLs);
