...
public class SSAOEffectDepthCutoff : MonoBehaviour
{
	...
	public float myFogDensity = 0.4f;
	...
	{
		if (!m_SSAOMaterial && m_SSAOShader != null && m_SSAOShader.isSupported)
		{
	...
	private void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		m_OcclusionIntensity = Mathf.Clamp(m_OcclusionIntensity, 0.5f, 8f);
		...
		m_SSAOMaterial.SetFloat("_FogDensity", myFogDensity);
		bool flag = m_Blur > 0;
