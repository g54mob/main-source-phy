...
namespace ch.sycoforge.Decal
{
	public class DecalAnimation : MonoBehaviour
	{
		...
		protected void SetTexturesScale(Vector2 size)
		{
			...
			foreach (string propertyName in inputTextureNames)
			{
				decalRenderer.material.SetTextureScale(propertyName, size);
			}
		}
		...
		protected void SetTexturesOffsets(Vector2 offset)
		{
			...
			foreach (string propertyName in inputTextureNames)
			{
				decalRenderer.material.SetTextureOffset(propertyName, offset);
			}
		}
	}
}
