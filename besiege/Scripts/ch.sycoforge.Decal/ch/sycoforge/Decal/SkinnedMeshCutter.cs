...
namespace ch.sycoforge.Decal
{
	public class SkinnedMeshCutter : MeshCutter<DynamicSkinnedMesh>
	{
		...
		private BoneWeight LerpBoneWeights(BoneWeight boneWeightA, BoneWeight boneWeightB, float stretchFactor)
		{
			...
			{
				boneIndex0 = indexedBones[0].Index,
				weight0 = indexedBones[0].Weight * num2,
				boneIndex1 = indexedBones[1].Index,
				weight1 = indexedBones[1].Weight * num2,
				boneIndex2 = indexedBones[2].Index,
				weight2 = indexedBones[2].Weight * num2,
				boneIndex3 = indexedBones[3].Index,
				weight3 = indexedBones[3].Weight * num2
			};
		}
	}
}
