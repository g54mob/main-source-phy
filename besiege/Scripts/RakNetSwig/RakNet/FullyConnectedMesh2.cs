...
namespace RakNet
{
	public class FullyConnectedMesh2 : PluginInterface2
	{
		...
		internal FullyConnectedMesh2(IntPtr cPtr, bool cMemoryOwn)
			: base(RakNetPINVOKE.FullyConnectedMesh2_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		{
			IntPtr intPtr = RakNetPINVOKE.FullyConnectedMesh2_GetInstance();
			return (intPtr == IntPtr.Zero) ? null : new FullyConnectedMesh2(intPtr, false);
		}

		public static void DestroyInstance(FullyConnectedMesh2 i)
		{
			RakNetPINVOKE.FullyConnectedMesh2_DestroyInstance(getCPtr(i));
		}

		public FullyConnectedMesh2()
			: this(RakNetPINVOKE.new_FullyConnectedMesh2(), true)
		{
		}
		...
		{
			return new RakNetGUID(RakNetPINVOKE.FullyConnectedMesh2_GetConnectedHost(swigCPtr), true);
		}

		public SystemAddress GetConnectedHostAddr()
		{
			return new SystemAddress(RakNetPINVOKE.FullyConnectedMesh2_GetConnectedHostAddr(swigCPtr), true);
		}

		public RakNetGUID GetHostSystem()
		{
			return new RakNetGUID(RakNetPINVOKE.FullyConnectedMesh2_GetHostSystem(swigCPtr), true);
		}

		public bool IsHostSystem()
		{
			return RakNetPINVOKE.FullyConnectedMesh2_IsHostSystem(swigCPtr);
		}
		...
		{
			return RakNetPINVOKE.FullyConnectedMesh2_IsConnectedHost(swigCPtr);
		}
		...
		{
			bool result = RakNetPINVOKE.FullyConnectedMesh2_HasParticipant(swigCPtr, RakNetGUID.getCPtr(participantGuid));
			if (RakNetPINVOKE.SWIGPendingException.Pending)
			{
				throw RakNetPINVOKE.SWIGPendingException.Retrieve();
			}
		...
		{
			return RakNetPINVOKE.FullyConnectedMesh2_GetParticipantCount__SWIG_0(swigCPtr);
		}
		...
		{
			return RakNetPINVOKE.FullyConnectedMesh2_GetTotalConnectionCount(swigCPtr);
		}
	}
}
