namespace RakNet
{
	public class RakNet
	{
		...
		public static int MAX_RPC_MAP_SIZE
		{
			get
			{
				return RakNetPINVOKE.MAX_RPC_MAP_SIZE_get();
			}
		}
		...
		public static int UNDEFINED_RPC_INDEX
		{
			get
			{
				return RakNetPINVOKE.UNDEFINED_RPC_INDEX_get();
			}
		}
		...
		public static ushort UNASSIGNED_PLAYER_INDEX
		{
			get
			{
				return RakNetPINVOKE.UNASSIGNED_PLAYER_INDEX_get();
			}
		}
		...
		public static ulong UNASSIGNED_NETWORK_ID
		{
			get
			{
				return RakNetPINVOKE.UNASSIGNED_NETWORK_ID_get();
			}
		}
		...
		public static int PING_TIMES_ARRAY_SIZE
		{
			get
			{
				return RakNetPINVOKE.PING_TIMES_ARRAY_SIZE_get();
			}
		}
		...
		public static uint MAX_UNSIGNED_LONG
		{
			get
			{
				return RakNetPINVOKE.MAX_UNSIGNED_LONG_get();
			}
		}

		public static void StatisticsToString(RakNetStatistics s, out string buffer, int verbosityLevel)
		{
			string buffer2 = new string('c', 9999);
			buffer = StatisticsToStringHelper(s, buffer2, verbosityLevel);
		}

		public static string StatisticsToStringHelper(RakNetStatistics s, string buffer, int verbosityLevel)
		{
			return RakNetPINVOKE.StatisticsToStringHelper(RakNetStatistics.getCPtr(s), buffer, verbosityLevel);
		}

		public static bool NonNumericHostString(string host)
		{
			return RakNetPINVOKE.NonNumericHostString(host);
		}

		public static RakString OpPlus(RakString lhs, RakString rhs)
		{
			RakString result = new RakString(RakNetPINVOKE.OpPlus(RakString.getCPtr(lhs), RakString.getCPtr(rhs)), true);
		...
		{
			return RakNetPINVOKE.GetTime();
		}

		public static uint GetTimeMS()
		{
			return RakNetPINVOKE.GetTimeMS();
		}

		public static ulong GetTimeUS()
		{
			return RakNetPINVOKE.GetTimeUS();
		}

		public static bool GreaterThan(ulong a, ulong b)
		{
			return RakNetPINVOKE.GreaterThan(a, b);
		}

		public static bool LessThan(ulong a, ulong b)
		{
			return RakNetPINVOKE.LessThan(a, b);
		}
	}
}
