...
namespace CodeAnimo.SurfaceWaves
{
	...
	public class WaveDisplaceRenderer : SimulationOutput
	{
		...
		private void SetupDepthClearMaterial()
		{
			...
			m_depthClearMaterial.SetFloat("_Depth", 1f);
		}
		...
		public override void RunStep()
		{
			...
			RenderTexture renderTexture = simTextureManager.CreateOutputTexture("Displacement Depth", true);
		...
		{
			GameObject gameObject = new GameObject("Wave Displacement Depth Camera", typeof(Camera));
