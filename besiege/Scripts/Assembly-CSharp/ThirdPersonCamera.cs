...
public class ThirdPersonCamera : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		if ((bool)controller)
		{
			...
			centerOffset = component.bounds.center - _target.position;
			headOffset = centerOffset;
			headOffset.y = component.bounds.max.y - _target.position.y;
		}
		else
		{
	...
	private void Apply(Transform dummyTarget, Vector3 dummyCenter)
	{
		...
		cameraTransform.position = new Vector3(position.x, y3, position.z);
