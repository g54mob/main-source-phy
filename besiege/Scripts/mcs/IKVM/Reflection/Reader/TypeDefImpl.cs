...
namespace IKVM.Reflection.Reader
{
	internal sealed class TypeDefImpl : TypeInfo
	{
		...
		internal override TypeName TypeName
		{
			get
			{
				return new TypeName(typeNamespace, typeName);
			}
		}
		...
		public override string Name
		{
			get
			{
				return TypeNameParser.Escape(typeName);
			}
		}
		...
		internal bool IsNestedByFlags
		{
			get
			{
				return (Attributes & TypeAttributes.VisibilityMask & ~TypeAttributes.Public) != 0;
			}
		}
