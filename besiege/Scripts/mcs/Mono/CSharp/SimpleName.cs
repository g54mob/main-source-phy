			...
			while (true)
			{
				...
				if (flag)
				{
					...
					else
					{
						...
						{
							MemberExpr memberExpr3 = Expression.MemberLookup(rc, false, rc.CurrentType, base.Name, base.Arity, restrictions & ~MemberLookupRestrictions.InvocableOnly, loc) as MemberExpr;
							if (memberExpr3 != null)
							{
								Expression.Error_UnexpectedKind(rc, memberExpr3, "method group", memberExpr3.KindName, loc);
