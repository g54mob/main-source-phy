	...
	public struct Location : IEquatable<Location>
	{
		...
		public int File
		{
			get
			{
				...
				{
					throw new Exception(string.Format("Should not happen. Token is {0:X04}, checkpoints are {1}, index is {2}", token, checkpoints.Length, CheckpointIndex));
				}
		...
		public Location(SourceFile file, int row, int column)
		{
			...
			long num = -1L;
			long num2 = 0L;
			int num3 = ((file != null) ? file.Index : 0);
