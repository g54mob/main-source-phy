...
namespace Mono.CSharp
{
	public class Invocation : ExpressionStatement
	{
		...
		{
			return System.Linq.Expressions.Expression.Call((instance == null) ? null : instance.MakeExpression(ctx), (MethodInfo)mi.GetMetaInfo(), Arguments.MakeExpression(args, ctx));
		}
