...
namespace Mono.CSharp
{
	public class AnonymousMethodExpression : Expression
	{
		...
		public TypeSpec InferReturnType(ResolveContext ec, TypeInferenceContext tic, TypeSpec delegate_type)
		{
			...
			{
				anonymousExpression = value as AnonymousExpression;
			...
			using (ec.Set(ResolveContext.Options.ProbingMode | ResolveContext.Options.InferReturnType))
			{
				...
				anonymousExpression = ((anonymousMethodBody == null) ? null : anonymousMethodBody.Compatible(ec, anonymousMethodBody));
