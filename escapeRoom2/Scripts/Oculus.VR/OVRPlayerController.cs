...
public class OVRPlayerController : MonoBehaviour
{
	...
	public virtual void UpdateMovement()
	{
		...
		if (EnableLinearMovement)
		{
			...
			bool flag3 = false;
			bool flag4 = false;
			flag = Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.UpArrow);
			flag2 = Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.LeftArrow);
			flag3 = Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.RightArrow);
			flag4 = Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow);
			bool flag5 = false;
