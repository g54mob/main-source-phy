...
namespace Meta.XR.BuildingBlocks
{
	public class SharedSpatialAnchorCore : SpatialAnchorCoreBuildingBlock
	{
		...
		private async void LoadSharedSpatialAnchorsRoutine(GameObject prefab, IEnumerable<Guid> uuids)
		{
			...
			{
				OVRResult<List<OVRSpatialAnchor.UnboundAnchor>, OVRSpatialAnchor.OperationResult> result = await OVRSpatialAnchor.LoadUnboundSharedAnchorsAsync(uuids, unboundAnchors);
				if (!result.Success)
				{
