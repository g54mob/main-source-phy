	...
	public class Message
	{
		...
		internal static Message ParseMessageHandle(IntPtr messageHandle)
		{
			...
			case MessageType.Challenges_GetNextEntries:
				...
				break;
			case MessageType.Cowatching_GetNextCowatchViewerArrayPage:
			case MessageType.Cowatching_GetViewersData:
				message = new MessageWithCowatchViewerList(messageHandle);
				break;
			case MessageType.Notification_Cowatching_ViewersDataChanged:
				message = new MessageWithCowatchViewerUpdate(messageHandle);
				break;
			case MessageType.Notification_Cowatching_InSessionChanged:
			case MessageType.Cowatching_IsInSession:
			...
			case MessageType.Cowatching_LaunchInviteDialog:
			...
			case MessageType.Cowatching_LeaveSession:
			case MessageType.Cowatching_SetViewerData:
			case MessageType.GroupPresence_SetLobbySession:
			case MessageType.Cowatching_ResignFromPresenting:
			...
			case MessageType.Cowatching_JoinSession:
			case MessageType.GroupPresence_Set:
			case MessageType.Cowatching_SetPresenterData:
			case MessageType.GroupPresence_Clear:
			case MessageType.Notification_MarkAsRead:
			case MessageType.Cowatching_RequestToPresent:
			...
			case MessageType.Notification_Cowatching_ApiReady:
			...
			case MessageType.Cowatching_GetPresenterData:
			case MessageType.Notification_Cowatching_SessionStopped:
			case MessageType.Notification_Cowatching_PresenterDataChanged:
			case MessageType.Application_LaunchOtherApp:
			case MessageType.Notification_Cowatching_ApiNotReady:
			case MessageType.Notification_Vrcamera_GetDataChannelMessageUpdate:
			case MessageType.Notification_Cowatching_SessionStarted:
			case MessageType.Notification_Cowatching_Initialized:
