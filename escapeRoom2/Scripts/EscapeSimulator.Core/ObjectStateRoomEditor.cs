...
[Serializable]
public class ObjectStateRoomEditor : IReadWrite
{
	public InstanceID gameObjectId;
	...
	{
		writer.WriteIReadWrite(gameObjectId);
		writer.Write(path);
	...
	{
		gameObjectId = reader.ReadIReadWrite<InstanceID>();
	...
	public override string ToString()
	{
		...
		stringBuilder.AppendLine("gameObjectId: " + ToStringHelper.Stringify(gameObjectId));
		...
		stringBuilder.Append("Light_Intensity: " + $"{Light_Intensity}");
