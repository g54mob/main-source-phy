...
public struct VRSimulatorControllerState : IInputStateTypeInfo
{
	[FieldOffset(0)]
	...
	[FieldOffset(35)]
	[InputControl(usage = "DevicePosition", offset = 35u, alias = "PointerPosition")]
	public Vector3 devicePosition;

	[FieldOffset(47)]
	[InputControl(usage = "DeviceRotation", offset = 47u, alias = "PointerRotation")]
	public Quaternion deviceRotation;

	public static FourCC formatId => new FourCC('V', 'R', 'S', 'C');

	public FourCC format => formatId;

	public VRSimulatorControllerState WithButton(VRSimulatorControllerButton button, bool state = true)
	{
	...
	public bool HasButton(VRSimulatorControllerButton button)
	{
		int num = 1 << (int)button;
