...
public class SteamManager : MonoBehaviour
{
	...
	protected virtual void Awake()
	{
		...
		try
		{
			if (SteamAPI.RestartAppIfNecessary(new AppId_t(Game.STEAM_APP_ID)))
			{
		...
		Debug.Log($"STEAM INIT ES {eSteamAPIInitResult} {OutSteamErrMsg}");
		if (!m_bInitialized)
		{
	...
	protected virtual void OnDestroy()
	{
		if (!(s_instance != this))
		{
			...
			if (m_bInitialized)
			{
				Debug.Log("[Steamworks.NET] Shutdown started");
				SteamAPI.Shutdown();
