...
public class Buttons : MonoBehaviour
{
	...
	public void Acacia()
	{
		...
		acacia.SetActive(value: true);
		beech.SetActive(value: false);
		birch.SetActive(value: false);
		dryTree.SetActive(value: false);
		fir.SetActive(value: false);
		juniper.SetActive(value: false);
		maple.SetActive(value: false);
		oak.SetActive(value: false);
		pine.SetActive(value: false);
		spruce.SetActive(value: false);
		sycamore.SetActive(value: false);
	}
	...
	public void Beech()
	{
		...
		acacia.SetActive(value: false);
		beech.SetActive(value: true);
		birch.SetActive(value: false);
		dryTree.SetActive(value: false);
		fir.SetActive(value: false);
		juniper.SetActive(value: false);
	...
	public void Spruce()
	{
		_camera.transform.position = new Vector3(100f, 61.8f, -120.8f);
