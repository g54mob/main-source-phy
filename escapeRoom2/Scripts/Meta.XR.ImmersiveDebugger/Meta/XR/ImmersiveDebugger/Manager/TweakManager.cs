...
namespace Meta.XR.ImmersiveDebugger.Manager
{
	internal class TweakManager : IDebugManager
	{
		...
		public void ProcessType(Type type)
		{
			...
			{
				if (TweakUtils.IsMemberTypeValidForTweak(memberInfo))
				{
			...
			list.AddRange(InspectedDataRegistry.GetMembersForType(type, (MemberInfo info, DebugMember attribute) => TweakUtils.IsMemberTypeValidForTweak(info) && attribute.Tweakable));
