...
namespace Meta.XR.ImmersiveDebugger.Manager
{
	internal class ActionManager : IDebugManager
	{
		...
		public void ProcessType(Type type)
		{
			...
			ManagerUtils.RebuildInspectorForType(_uiPanel, _instanceCache, type, list, delegate(IMember memberController, MethodInfo member, DebugMember attribute, UnityEngine.Object instance)
			{
