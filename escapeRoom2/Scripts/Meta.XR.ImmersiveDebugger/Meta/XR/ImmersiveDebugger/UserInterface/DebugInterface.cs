...
namespace Meta.XR.ImmersiveDebugger.UserInterface
{
	public class DebugInterface : Interface
	{
		...
		internal override void Awake()
		{
			...
			_followButton = _bar.RegisterControl("followMove", Resources.Load<Texture2D>("Textures/move_icon"), delegate
			{
				FollowOverride = !FollowOverride;
			});
			_rotateButton = _bar.RegisterControl("followRotation", Resources.Load<Texture2D>("Textures/rotate_icon"), delegate
			{
