...
namespace I2.Loc
{
	...
	public class LanguageSourceData
	{
		...
		public string Import_CSV(string Category, string CSVstring, eSpreadsheetUpdateMode UpdateMode = eSpreadsheetUpdateMode.Replace, char Separator = ',')
		{
			...
			return Import_CSV(string.Empty, Category, cSV, UpdateMode);
		}
		...
		public string Import_CSV(string customLangCode, string Category, List<string[]> CSV, eSpreadsheetUpdateMode UpdateMode = eSpreadsheetUpdateMode.Replace)
		{
			string[] array = CSV[0];
			int num = 1;
			int num2 = -1;
			...
			if (array.Length > 1 && ArrayContains(array[0], texts))
			{
				...
				for (int i = 0; i < num4; i++)
				{
					...
					if (!string.IsNullOrEmpty(customLangCode))
					{
						code = customLangCode;
					}
					int num5 = -1;
