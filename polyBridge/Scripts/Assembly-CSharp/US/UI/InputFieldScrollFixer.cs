...
namespace US.UI
{
	...
	public class InputFieldScrollFixer : MonoBehaviour, IBeginDragHandler, IEventSystemHandler, IEndDragHandler, IDragHandler, IScrollHandler, IPointerUpHandler
	{
